...
8-9 Пересечение луча и сферы (О) / триангуляций (О) / цилиндра (Д) / конуса (Д) / тора (Д). Для сфер использован код преподавателя, для триангуляций взят отсюда https://en.wikipedia.org/wiki/M%C3%B6ller%E2%80%93Trumbore_intersection_algorithm
